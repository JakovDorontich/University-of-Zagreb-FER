...
if __name__ == '__main__':
    ...
    NN.addLayer(LinearLayer(input_size, 24))
    NN.addLayer(SigmoidLayer())
    NN.addLayer(LinearLayer(24, 24))
    NN.addLayer(SigmoidLayer())
    NN.addLayer(LinearLayer(24, output_size))
    ...
    populationSize = 24 # The number of chromosomes
    mutationProbability  = .7 # Probability of mutation
    mutationScale = 15. # Standard deviation of the gaussian noise
    ...
    plot_every = 5000 # Plot the actual vs estimated functions every this many iterations
